...
if ($InstallVersion -ne "") {
    ...
    $ApiUrl = "https://api.github.com/repos/kadidalax/komari-agent-1.2.60/releases/latest"
    try {
...
$BinaryName = "komari-agent-windows-$arch.exe"
$DownloadUrl = if ($GitHubProxy) { "$GitHubProxy/https://github.com/kadidalax/komari-agent-1.2.60/releases/download/$versionToInstall/$BinaryName" } else { "https://github.com/kadidalax/komari-agent-1.2.60/releases/download/$versionToInstall/$BinaryName" }
